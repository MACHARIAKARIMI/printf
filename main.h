...
int handlers_print(const char *fmt, int *i,
...
int iprint_anhexa(va_list types, char map_to[],
...
/* width handler */
int ihandle_write_char(char c, char buffer[],
	int flags, int width, int precision, int size);
int wewrite_number(int is_positive, int ind, char buffer[],
	int flags, int width, int precision, int size);
int iwrite_num(int ind, char bff[], int flags, int width, int precision,
	int length, char padd, char extra_c);
int iwrites_pointer(char buffer[], int ind, int length,
	int width, int flags, char padd, char extra_c, int padd_start);

int hewrite_unsgnd(int is_negative, int ind,
char buffer[],
	int flags, int width, int precision, int size);

/****************** UTILS ******************/
int itis_printable(char);
int happends_hexa_code(char, char[], int);
int its_digit(char);

long int converting_size_number(long int num, int size);
long int convertes_size_unsgnd(unsigned long int num, int size);
